...
- Lane2 preserves higher-kinded polymorphic values through **Buslane F-Omega Constructs** rather than erasing them before Buslane.
...
- Every **Type Alias Function** is a **Top-Level Type Alias**; Lane2 does not support local type alias declarations.
...
- Lane2 kind arrows use **Parameter-List Kind** syntax and are not curried.
