...
This document records the current Lane2 design direction for existential
types. It is a design note, not an implemented language feature.

## Goal

Lane2 supports universal type parameters and existential type parameters as
separate concepts.
...
Lane2 does not need dependent types for this feature. In particular, this
...
Lane2 surface syntax maps to these rules:
